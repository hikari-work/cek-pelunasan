...
func (g *HTMLGenerator) writeDebiturInfo(b *strings.Builder, dto *JsonDto) {
	...
	// Signature grid
	b.WriteString("          <!-- Kanan: Grid -->\n")
	b.WriteString("          <div style=\"display: grid; grid-template-columns: 80px 80px 80px; border: 0.5px solid blue; font-family: sans-serif; font-size: 12px;\">\n")
	b.WriteString("            <div style=\"border: 0.5px solid blue; font-weight: bold; color: blue; text-align: center; padding: 4px;\">Petugas</div>\n")
	b.WriteString("            <div style=\"border: 0.5px solid blue; font-weight: bold; color: blue; text-align: center; padding: 4px;\">Pemeriksa</div>\n")
	b.WriteString("            <div style=\"border: 0.5px solid blue; font-weight: bold; color: blue; text-align: center; padding: 4px;\">Pimpinan</div>\n")
	b.WriteString("            \n")
	b.WriteString("            <div style=\"border: 0.5px solid blue; height: 40px;\"></div>\n")
	b.WriteString("            <div style=\"border: 0.5px solid blue; height: 40px;\"></div>\n")
	b.WriteString("            <div style=\"border: 0.5px solid blue; height: 40px;\"></div>\n")
	b.WriteString("          </div>\n")
	b.WriteString("        </div>\n\n")
