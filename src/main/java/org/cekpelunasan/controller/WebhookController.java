...
import org.cekpelunasan.service.whatsapp.WhatsAppCommandRouters;
...
public class WebhookController {
	...
	private final WhatsAppCommandRouters whatsAppCommandRouters;

	public WebhookController(@Value("${telegram.bot.token}") String botToken,
							 TelegramBot telegramBot,
							 WhatsAppCommandRouters whatsAppCommandRouters) {
		this.telegramClient = new OkHttpTelegramClient(botToken);
		this.telegramBot = telegramBot;
		this.whatsAppCommandRouters = whatsAppCommandRouters;
	}
	...
	public ResponseEntity<?> whatsappV2(@RequestBody WhatsAppWebhookDTO dto) {
		whatsAppCommandRouters.whatsappCommandRouter(dto);
