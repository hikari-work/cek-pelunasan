/**
 * canvas.js — Render kartu dan detail untuk layanan Canvasing Tabungan.
 */
  ...
  function buildCard(item) {
    ...
    div.innerHTML = `
      <div class="result-card-inner">
        ...
        ${item.address ? `<div class="result-address">${escHtml(item.address)}</div>` : ''}
    ...
    `;
    div.addEventListener('click', () => App.openDetail('canvas', item.tabId));
    return div;
  }
